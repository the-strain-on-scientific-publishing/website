...
![A different take on self-citations. Plotting frequency of articles instead of average journal self-citation](articles_self_cite.png)

::: column-margin
![Original histogram with average journal self-citation](scr_mdpi.png){width="300"}
:::
