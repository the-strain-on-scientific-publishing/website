...
![The Strain Explorer app is here!](thumbn.png){fig-align="center" width="627"}
...
## The nitty gritty details {#callout-1}
...
In the file Shiny_scripts_data_release.zip there is a folder setup in an R package format. Download this, unzip the file, and open the Rproject and the main analysis script. The “Scripts” folder does not need to be touched. But you will need to follow the instructions below to populate the folders with the data needed for running the analysis.
